...
/**
 * Plugin implementation of the 'SLAC Button' formatter.
 *
 * @FieldFormatter(
 *   id = "slac_helper_slac_button",
 *   label = @Translation("SLAC Button"),
 *   field_types = {
 *     "link"
 *   }
 * )
 */
class SlacButtonFormatter extends LinkFormatter {
