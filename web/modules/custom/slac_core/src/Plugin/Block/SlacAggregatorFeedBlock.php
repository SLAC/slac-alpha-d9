 ...
 *
 * @Block(
 *   id = "slac_aggregator_feed_block",
 *   admin_label = @Translation("Trending News Feed"),
 *   category = @Translation("SLAC")
 * )
 */
class SlacAggregatorFeedBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function defaultConfiguration() {
    // By default, the block will contain 6 feed items.
    return [
      'block_count' => 6,
      'feed' => NULL,
      'kicker' => NULL,
  ...
  public function blockForm($form, FormStateInterface $form_state) {
   ...
   $form['kicker'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Kicker'),
      '#description' => $this->t('Enter text to be displayed below title'),
  ...
  public function blockSubmit($form, FormStateInterface $form_state) {
    ...
    $this->configuration['kicker'] = $form_state->getValue('kicker');
  }
  ...
  public function build() {
    ...
    if ($result) {
      ...
      $build['kicker'] = [
        '#markup' => $this->configuration['kicker'],
      ];
      $build['list'] = [
        '#theme' => 'item_list',
        '#items' => [],
